...
read_from_data(connection,16721739,str(start_values_time),start_values_energy)

start_values_time = get_start_values_time(17717664)
start_values_energy = get_start_values_energy(17717664)
read_from_data(connection,17717664,str(start_values_time),start_values_energy)
